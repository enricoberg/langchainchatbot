...
def get_conversational_chain():
    ...
    provided context just say, "Mi dispiace, non ho trovato una risposta nelle procedure BAI caricate a sistema...". don't provide the wrong answer. The answer MUST be in italian all the times.\n\n
    Context:\n {context}?\n
    Question: \n{question}\n
